...
function DashboardPage() {
  ...
  try {
    ...
    setRequests(nextRequests);
    setNotice(`อัปเดตสถานะคำร้อง ${requestId} แล้ว`);
  } catch (error) {
        ...
        <>
          ...
          <section className="panel" aria-labelledby="request-list-title">
            ...
            <div className="search-box">
              <input type="text" placeholder="ค้นหาจากผู้แจ้งหรือรายละเอียด" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
            </div>
