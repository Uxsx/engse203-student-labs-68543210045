import { useState } from 'react'; // อย่าลืม import useState
...
function App() {
  // LAB4-R04: เปลี่ยน requests/statusFilter เป็น state
  const [requests, setRequests] = useState(initialRequests);
  const [statusFilter, setStatusFilter] = useState('all');

  // LAB4-R04: คำนวณ summary เป็น derived data
  const summary = {
  ...
  // LAB4-R08: คำนวณ filteredRequests จาก requests + statusFilter
